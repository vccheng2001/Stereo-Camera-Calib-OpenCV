...
img1 = cv2.imread(imgR_path,0)  #queryimage # left image
img2 = cv2.imread(imgL_path,0) #trainimage # right image

# img1 = downsample_image(img1, 0.25)
# img2 = downsample_image(img2, 0.25)
