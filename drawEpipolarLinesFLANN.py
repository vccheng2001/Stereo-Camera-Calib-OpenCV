...
''' 
Given two images taken by the right/left camera,
computes and draws epilines corresponding to 
points in the left image, and vice versa. 
...
def main(args): 
    ...
    img1 = cv2.imread(args.img_right,0) 
    img2 = cv2.imread(args.img_left,0) 
    ...
    # Lowe's ratio test, append good points 
